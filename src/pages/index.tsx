  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Time Tracker - Your ultimate solution for clocking in and clocking out employees. Experience the ease of time tracking with precision and reliability."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1524678714210-9917a6c619c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0aW1lJTIwdHJhY2tpbmd8ZW58MHx8fHwxNjk2OTczMzczfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@icons8?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Icons8 Team`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Time Tracker - Your ultimate solution for clocking in and clocking out employees. Experience the ease of time tracking with precision and reliability.`}
            </Text>
            <Box
